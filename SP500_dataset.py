...
def SP500_split(seq_length):
    ...
    data = sp500_data[features].values
    ...
    train_end_idx = sp500_data.index.get_loc(sp500_data.index.asof(train_end_date))
    val_end_idx = sp500_data.index.get_loc(sp500_data.index.asof(val_end_date))
